...
| [Anthropic frontend-design](https://github.com/anthropics/skills/tree/main/skills/frontend-design) | Subject-specific direction, type as hierarchy and identity, meaningful structural devices, and concentrated emphasis | Use the synthesis in `design-judgment.md`. Brief-specific choices outrank anti-template warnings. No duplicate trigger or mandatory design-plan ceremony. |
| [Impeccable](https://github.com/pbakaus/impeccable) | Surface-specific priorities; typography, grouping, resilient states, and separating critique from mechanical checks | Use the adapted judgment reference, not its launcher, detectors, option boards, random concept assignment, mandatory subagents, image generation, or persistence system. Do not import blanket aesthetic bans or model-specific rules without local evidence. |
| [Hallmark](https://github.com/Nutlope/hallmark) | Structure before styling; vocabulary for composition and rhythm; explicit content-honesty checks | Borrow decision principles, not theme rotation, typography/color quotas, global overflow clipping, quality stamps, or compulsory user comparisons. Product consistency and accessibility outrank variety. |
