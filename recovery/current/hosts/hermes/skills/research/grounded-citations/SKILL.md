...
metadata:
  hermes:
    ...
    category: research
    related_skills: [research-source-operations, pdf, reddit-reading, rss-feeds, youtube-content]
---
...
for paper metadata and BibTeX use `research-source-operations` and its
`references/paper-apis.md` (see also `references/citation-formats.md`).
