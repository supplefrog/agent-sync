...
cronjob(action="create",
        schedule="every 6h",
        prompt="Load the monitoring-workflows skill, follow references/product-price-monitor/SKILL.md, and run the tick for the watch contract at ~/.hermes/price-watches/<watch-slug>.json.",
