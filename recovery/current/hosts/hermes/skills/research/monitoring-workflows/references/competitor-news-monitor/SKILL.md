...
cronjob(action="create",
        ...
        prompt="Load the monitoring-workflows skill, follow references/competitor-news-monitor/SKILL.md, and run the tick for the watch contract at ~/.hermes/competitor-watches/<watch-slug>.json.",
