# Legacy pre-1.0 Examples

These examples target an old API, not current production Outlines. Use only
for an intentionally pinned compatible project. For modern extraction,
classification, forms, entity/code schemas and batching, use the
[current examples](../SKILL.md); do not mix API generations.
