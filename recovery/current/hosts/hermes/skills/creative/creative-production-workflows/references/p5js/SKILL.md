...
8. **Load references on demand** — use `skill_view(name="creative-production-workflows", file_path="references/p5js/references/...")` to load specific reference files as needed during implementation
