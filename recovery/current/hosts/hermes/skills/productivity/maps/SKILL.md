...
Use the resolved directory of this skill as `SKILL_DIR`; the script is `SKILL_DIR/scripts/maps_client.py`. Do not assume the legacy Hermes home or a flat skill layout.
